...
record.read_cap_frames((80,120), gap, -1)
print("Frames read")
...
start = time.time()
sleep_quality = SleepState(record.pose_list, record.motion_detection_list, record.detect_object_frames(0.01), st, framerate=60/gap, epoch_len=210, movement_threshhold=0.0008 , wake_threshhold=0.006)
